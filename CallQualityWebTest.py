...
# Check input is a valid IP, Error if it isnt and return to prompt.
    ...
    def Webpage(adddrops=0, duplexdrop=0, intdrops=0):
        ...
        print
        print('<p style= "color: DodgerBlue; font-weight: bold;')
        print('font-family: Verdana; font-size: 1.1em;')
        print('position: absolute; left: 10px">Reading Logs...</p>')
        print
        print(adddrops)
        print
        print('<br>')
        print('<p style= "color: DodgerBlue; font-weight: bold;')
        print('font-family: Verdana; font-size: 1.1em;')
        print('position: absolute; left: 10px">Checking Duplex...</p>')
        print
        print(duplexdrop)
        print
        print('<br>')
        print('<p style= "color: DodgerBlue; font-weight: bold;')
        print('font-family: Verdana; font-size: 1.1em;')
        print('''position: absolute; left: 10px">Checking interfaces
        for errors...</p>''')
        print
        print(intdrops)
        print
...
font-family: Verdana; font-size: 1.2em;
position: absolute; left: 10px">No Drops Seen in Logs</p>
<br>
'''
    if "down" in logs:
        print(Webpage(dropspage, 0, 0))
    elif logs:
        print(Webpage(nodrop, 0, 0))

    # Check duplex settings on interfaces.
    # Will display error


def checkduplex(duplex):
...
<p style= "color: Red; font-weight: bold;
font-family: Verdana; font-size: 1.2em;
position: absolute; left: 10px">HALF DUPLEX DISCOVERED.
  PLEASE CONNECT TO DEVICE AND INVESTIGATE (sh int status)</p>
<br>
'''
    if "half" in duplex:
        print(checklogs() + Webpage(0, duphalf, 0))
    elif duplex:
        print(checklogs() + Webpage(0, noissues, 0))
